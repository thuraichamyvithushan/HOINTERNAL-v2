                    ...
                    {visibleVideos.map((video) => {
                        ...
                        >
                            <div className="video-thumbnail">
                                ...
                                <div className="play-overlay">
                                    <div className="play-button-icon">
                                        <FontAwesomeIcon
                                            icon={cardMediaKind === 'folder' ? faImages : (cardMediaKind === 'image' ? faImage : faPlay)}
                                            className={cardMediaKind === 'video' ? 'icon-ml-1' : ''}
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="video-info">
                                <h3 className="video-title">{video.isFolder ? (video.folderName || 'Image Folder') : (cardItem.deviceName || 'Unknown Device')}</h3>
                                ...
                                <div className="meta-stack">
                                    ...
                                    <div className="meta-item-small location-meta">
                                        ...
                                        <span>{cardItem.ausState || (cardItem.location || 'Australia')}</span>
                                    </div>
                                </div>
                    ...
                    <div className="modal-content modern-edit-modal" onClick={e => e.stopPropagation()}>
                        <div className="modal-header accent-header">
                            ...
                            <div className="header-text">
                                <h3 className="modal-title-modern">{editingVideo?.isFolder ? 'Edit Folder Metadata' : 'Edit Metadata'}</h3>
                            ...
                            <div className="modal-meta-grid">
                                ...
                                <div className="modal-meta-item">
                                    ...
                                    <div className="modal-meta-content">
                                        ...
                                        <span className="modal-meta-value">
                                            {selectedVideo.isFolder
                                                ? (selectedVideo.items[currentGalleryIndex] || selectedVideo.coverImage)?.ausState || ((selectedVideo.items[currentGalleryIndex] || selectedVideo.coverImage)?.location || 'Australia')
                                                : (selectedVideo.ausState || (selectedVideo.location || 'Australia'))}
                                        </span>
                                    </div>
                                </div>
                                <div className="modal-meta-item">
