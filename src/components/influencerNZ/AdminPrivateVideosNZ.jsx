    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            try {
                ...
                // Filter users to only show influencers from New Zealand
                const influencers = data.filter(u => u.role === 'influencer' && u.country === 'New Zealand');
        ...
        return (
            <div className="admin-user-videos-view">
                ...
                <div className="view-grid-wrapper">
                    <ViewFootageNZ visibilityFilter="private" refreshTrigger={0} overrideUserId={selectedUserId} />
                </div>
            </div>
        );
    }
...
export default AdminPrivateVideosNZ;
